import { SpriteDefinition } from '../../../scripts/generate-sprite-pngs';
...
export const TemplateSprite: SpriteDefinition = {
  ...
  // Pixel map: 2D array of color indices (0 = transparent)
  // Each row represents a horizontal line of pixels
  // Each number references a color from the palette above
  pixels: [
